                    ...
                    <div className="collapse navbar-collapse" id="navbarNav">
                        <ul className="navbar-nav">
                            <li className="nav-item mx-1">
                                <a className="btn nav-link active  text-light fs-5" aria-current="page" href="/home">Home</a>
                            </li>
                            <li className="nav-item mx-1">
                                <a className="btn nav-link  text-light fs-5" href="/compose">Compose</a>
                            </li>
                        </ul>
                        ...
                        <div className="mt-2" style={{ "marginLeft": "auto" }}>
                            <ul className="navbar-nav">
                            <li className="nav-item me-3"> <p className="btn text-white fs-5 ">{props.name}</p></li>
